...
genera observaciones normales univariantes e independientes entre sí, y para un tamaño muestral $n$ a elegir, genérese una muestra de un vector $\textbf{X} = (X_1, X_2)'$ con distribución $N_2(\textbf{0}, \textbf{I})$.

Vamos a generar dos vectores de dimensión $n = 10$ que signa distribuciones $N(0,1)$ e independientes entre sí con el comando `rnorm`.
...
Realicemos las combinaciones lineales (3.2) y juntemos los dos vectores en una matriz.
